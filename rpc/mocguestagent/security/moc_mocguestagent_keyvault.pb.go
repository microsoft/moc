...
// source: moc_mocguestagent_keyvault.proto
...
func (*KeyVaultRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_32d5c76f971c57d8, []int{0}
}
...
func (*KeyVaultResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_32d5c76f971c57d8, []int{1}
}
...
func (*KeyVault) Descriptor() ([]byte, []int) {
	return fileDescriptor_32d5c76f971c57d8, []int{2}
}
...
func init() {
	proto.RegisterType((*KeyVaultRequest)(nil), "moc.mocguestagent.security.KeyVaultRequest")
	proto.RegisterType((*KeyVaultResponse)(nil), "moc.mocguestagent.security.KeyVaultResponse")
	proto.RegisterType((*KeyVault)(nil), "moc.mocguestagent.security.KeyVault")
}

func init() { proto.RegisterFile("moc_mocguestagent_keyvault.proto", fileDescriptor_32d5c76f971c57d8) }

var fileDescriptor_32d5c76f971c57d8 = []byte{
	// 444 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *keyVaultAgentClient) Invoke(ctx context.Context, in *KeyVaultRequest, opts ...grpc.CallOption) (*KeyVaultResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/moc.mocguestagent.security.KeyVaultAgent/Invoke", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _KeyVaultAgent_Invoke_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/moc.mocguestagent.security.KeyVaultAgent/Invoke",
	}
...
var _KeyVaultAgent_serviceDesc = grpc.ServiceDesc{
	ServiceName: "moc.mocguestagent.security.KeyVaultAgent",
	...
	Metadata: "moc_mocguestagent_keyvault.proto",
}
