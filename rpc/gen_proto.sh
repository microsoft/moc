...
Module="network"
echo "Generating $Agent/$Module protoc"
# Lnet has a dependency on NSG - make sure NSG is generated first
...
protoc -I $Agent/$Module/logicalnetwork -I $Agent/$Module/networksecuritygroup  -I ./common  $Agent/$Module/logicalnetwork/moc_cloudagent_logicalnetwork.proto --go_out=plugins=grpc:../bld/gen/
