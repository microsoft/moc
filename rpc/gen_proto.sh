...
protoc -I $Agent/$Module/virtualmachine -I ./common -I $Agent/network/virtualnetworkinterface $Agent/$Module/virtualmachine/moc_nodeagent_virtualmachine.proto --go_out=plugins=grpc:../bld/gen/
...
protoc -I $Agent/$Module/placementgroup -I $Agent/$Module/availabilityset -I ./common $Agent/$Module/placementgroup/moc_cloudagent_placementgroup.proto  --go_out=plugins=grpc:../bld/gen/
