...
type GalleryImage struct {
	...
	ContainerName string         `protobuf:"bytes,11,opt,name=containerName,proto3" json:"containerName,omitempty"`
	// Source of the GalleryImage from where we can copy the image from.
	SourcePath           string                     `protobuf:"bytes,12,opt,name=sourcePath,proto3" json:"sourcePath,omitempty"`
	Tags                 *common.Tags               `protobuf:"bytes,13,opt,name=tags,proto3" json:"tags,omitempty"`
	SourceType           common.ImageSource         `protobuf:"varint,14,opt,name=sourceType,proto3,enum=moc.ImageSource" json:"sourceType,omitempty"`
	...
	HyperVGeneration     common.HyperVGeneration    `protobuf:"varint,16,opt,name=hyperVGeneration,proto3,enum=moc.HyperVGeneration" json:"hyperVGeneration,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_unrecognized     []byte                     `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}
...
var fileDescriptor_4b5fad170433da5e = []byte{
	...
	,
}
