...
type VirtualMachinePrecheckResponse struct {
	...
	// The placement of virtual machines during precheck, in mapping from virtual machine names to node names.
...
func (m *VirtualMachinePrecheckResponse) GetPlacement() map[string]string {
	if m != nil {
		return m.Placement
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "moc.cloudagent.compute.VirtualMachinePrecheckResponse.PlacementEntry")
}
...
var fileDescriptor_a65ab853cd24c92b = []byte{
	...
	,
}
