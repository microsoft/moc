...
type KeyOperationRequest struct {
	...
	SigningInfo          *SigningInfo        `protobuf:"bytes,5,opt,name=signingInfo,proto3" json:"signingInfo,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
func (m *KeyOperationRequest) GetSigningInfo() *SigningInfo {
	if m != nil {
...
type SigningInfo struct {
	Padding              common.SignaturePaddingAlgorithm `protobuf:"varint,1,opt,name=Padding,proto3,enum=moc.SignaturePaddingAlgorithm" json:"Padding,omitempty"`
	Algorithm            common.CryptoSignatureAlgorithm  `protobuf:"varint,2,opt,name=Algorithm,proto3,enum=moc.CryptoSignatureAlgorithm" json:"Algorithm,omitempty"`
	PSSSaltLength        int32                            `protobuf:"varint,3,opt,name=PSSSaltLength,proto3" json:"PSSSaltLength,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                         `json:"-"`
	XXX_unrecognized     []byte                           `json:"-"`
	XXX_sizecache        int32                            `json:"-"`
}
...
func (m *SigningInfo) GetPadding() common.SignaturePaddingAlgorithm {
	if m != nil {
		return m.Padding
	}
	return common.SignaturePaddingAlgorithm_PKCSv1
}

func (m *SigningInfo) GetAlgorithm() common.CryptoSignatureAlgorithm {
	if m != nil {
		return m.Algorithm
	}
	return common.CryptoSignatureAlgorithm_unused
}

func (m *SigningInfo) GetPSSSaltLength() int32 {
	if m != nil {
		return m.PSSSaltLength
	}
	return 0
}
...
func init() {
	...
	proto.RegisterType((*SigningInfo)(nil), "moc.cloudagent.security.SigningInfo")
...
var fileDescriptor_d1154d4ecd5d6df6 = []byte{
	...
	,
}
