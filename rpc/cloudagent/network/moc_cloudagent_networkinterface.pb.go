...
type NetworkInterface struct {
	...
	NetworkSecurityGroup *common.NetworkSecurityGroupReference `protobuf:"bytes,15,opt,name=networkSecurityGroup,proto3" json:"networkSecurityGroup,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                              `json:"-"`
	XXX_unrecognized     []byte                                `json:"-"`
	XXX_sizecache        int32                                 `json:"-"`
}
...
func (m *NetworkInterface) GetNetworkSecurityGroup() *common.NetworkSecurityGroupReference {
	if m != nil {
		return m.NetworkSecurityGroup
	}
	return nil
...
var fileDescriptor_641284ba8360303c = []byte{
	...
	,
}
