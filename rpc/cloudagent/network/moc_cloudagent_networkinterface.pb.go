...
type NetworkInterface struct {
	...
	NetworkSecurityGroup *common.ResourceReference             `protobuf:"bytes,14,opt,name=networkSecurityGroup,proto3" json:"networkSecurityGroup,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                              `json:"-"`
	XXX_unrecognized     []byte                                `json:"-"`
	XXX_sizecache        int32                                 `json:"-"`
}
...
func (m *NetworkInterface) GetNetworkSecurityGroup() *common.ResourceReference {
	if m != nil {
...
var fileDescriptor_641284ba8360303c = []byte{
	...
	,
}
