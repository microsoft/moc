...
type IpConfiguration struct {
	...
	SubnetRef               *common.SubnetReference               `protobuf:"bytes,13,opt,name=subnetRef,proto3" json:"subnetRef,omitempty"`
	XXX_NoUnkeyedLiteral    struct{}                              `json:"-"`
	XXX_unrecognized        []byte                                `json:"-"`
	XXX_sizecache           int32                                 `json:"-"`
}
...
func (m *IpConfiguration) GetSubnetRef() *common.SubnetReference {
	if m != nil {
		return m.SubnetRef
	}
	return nil
...
var fileDescriptor_641284ba8360303c = []byte{
	...
	,
}
