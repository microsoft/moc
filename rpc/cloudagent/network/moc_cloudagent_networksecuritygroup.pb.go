...
type NetworkSecurityGroup struct {
	...
	LnetRefs                  []string                    `protobuf:"bytes,9,rep,name=lnetRefs,proto3" json:"lnetRefs,omitempty"`
	VnetRefs                  []string                    `protobuf:"bytes,10,rep,name=vnetRefs,proto3" json:"vnetRefs,omitempty"`
	IpRefs                    []string                    `protobuf:"bytes,11,rep,name=ipRefs,proto3" json:"ipRefs,omitempty"`
	XXX_NoUnkeyedLiteral      struct{}                    `json:"-"`
	XXX_unrecognized          []byte                      `json:"-"`
	XXX_sizecache             int32                       `json:"-"`
}
...
func (m *NetworkSecurityGroup) GetLnetRefs() []string {
	if m != nil {
		return m.LnetRefs
	}
	return nil
...
func (m *NetworkSecurityGroup) GetVnetRefs() []string {
	if m != nil {
		return m.VnetRefs
	}
	return nil
...
func (m *NetworkSecurityGroup) GetIpRefs() []string {
	if m != nil {
		return m.IpRefs
	}
	return nil
...
var fileDescriptor_f7a6eb5efc25ffee = []byte{
	...
	,
}
