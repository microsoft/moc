...
const (
	RegistrationStatus_notRegistered RegistrationStatus = 0
...
type OsRegistrationStatus struct {
	Status               RegistrationStatus `protobuf:"varint,1,opt,name=status,proto3,enum=moc.common.RegistrationStatus" json:"status,omitempty"`
...
func (m *OsRegistrationStatus) GetStatus() RegistrationStatus {
	if m != nil {
		return m.Status
	}
	return RegistrationStatus_notRegistered
}
...
func init() {
	proto.RegisterEnum("moc.common.RegistrationStatus", RegistrationStatus_name, RegistrationStatus_value)
...
var fileDescriptor_7c83f03f7e6831a3 = []byte{
	...
	,
}
