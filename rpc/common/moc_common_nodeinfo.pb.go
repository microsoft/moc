...
func (m *HyperVMemory) Reset()         { *m = HyperVMemory{} }
func (m *HyperVMemory) String() string { return proto.CompactTextString(m) }
func (*HyperVMemory) ProtoMessage()    {}
func (*HyperVMemory) Descriptor() ([]byte, []int) {
	return fileDescriptor_7c83f03f7e6831a3, []int{3}
}

func (m *HyperVMemory) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_HyperVMemory.Unmarshal(m, b)
}
func (m *HyperVMemory) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_HyperVMemory.Marshal(b, m, deterministic)
}
func (m *HyperVMemory) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HyperVMemory.Merge(m, src)
}
func (m *HyperVMemory) XXX_Size() int {
	return xxx_messageInfo_HyperVMemory.Size(m)
}
func (m *HyperVMemory) XXX_DiscardUnknown() {
	xxx_messageInfo_HyperVMemory.DiscardUnknown(m)
}

var xxx_messageInfo_HyperVMemory proto.InternalMessageInfo

func (m *HyperVMemory) GetSizeBytes() uint64 {
	if m != nil {
		return m.SizeBytes
	}
	return 0
...
type Resources struct {
	...
	HypervMemory         *HyperVMemory               `protobuf:"bytes,8,opt,name=hypervMemory,proto3" json:"hypervMemory,omitempty"`
...
func (*Resources) Descriptor() ([]byte, []int) {
	return fileDescriptor_7c83f03f7e6831a3, []int{7}
}
...
func (m *Resources) GetHypervMemory() *HyperVMemory {
	if m != nil {
		return m.HypervMemory
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*HyperVMemory)(nil), "moc.common.HyperVMemory")
...
var fileDescriptor_7c83f03f7e6831a3 = []byte{
	...
	,
}
