...
const (
	...
	VirtualMachineSizeType_Standard_NC4_H100     VirtualMachineSizeType = 50
	VirtualMachineSizeType_Standard_NC8_H100     VirtualMachineSizeType = 51
	VirtualMachineSizeType_Standard_NC16_H100    VirtualMachineSizeType = 52
	VirtualMachineSizeType_Standard_NC32_H100    VirtualMachineSizeType = 53
...
var VirtualMachineSizeType_name = map[int32]string{
	...
	50: "Standard_NC4_H100",
	51: "Standard_NC8_H100",
	52: "Standard_NC16_H100",
	53: "Standard_NC32_H100",
	95: "Custom_A2",
	96: "Custom_NK",
	97: "Custom_Gpupv",
	98: "Custom",
...
var VirtualMachineSizeType_value = map[string]int32{
	...
	"Standard_NC4_H100":     50,
	"Standard_NC8_H100":     51,
	"Standard_NC16_H100":    52,
	"Standard_NC32_H100":    53,
	"Custom_A2":             95,
	"Custom_NK":             96,
	"Custom_Gpupv":          97,
	"Custom":                98,
...
var fileDescriptor_7d1a061f6c82445b = []byte{
	...
	,
}
