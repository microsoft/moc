...
type VirtualMachineCheckpointOperation int32

const (
	VirtualMachineCheckpointOperation_CREATE  VirtualMachineCheckpointOperation = 0
	VirtualMachineCheckpointOperation_DESTROY VirtualMachineCheckpointOperation = 1
	VirtualMachineCheckpointOperation_RESTORE VirtualMachineCheckpointOperation = 2
	VirtualMachineCheckpointOperation_RENAME  VirtualMachineCheckpointOperation = 3
)

var VirtualMachineCheckpointOperation_name = map[int32]string{
	0: "CREATE",
	1: "DESTROY",
	2: "RESTORE",
	3: "RENAME",
...
var VirtualMachineCheckpointOperation_value = map[string]int32{
	"CREATE":  0,
	"DESTROY": 1,
	"RESTORE": 2,
	"RENAME":  3,
...
func (x VirtualMachineCheckpointOperation) String() string {
	return proto.EnumName(VirtualMachineCheckpointOperation_name, int32(x))
}

func (VirtualMachineCheckpointOperation) EnumDescriptor() ([]byte, []int) {
...
const (
	CheckpointType_Production     CheckpointType = 0
	CheckpointType_Disabled       CheckpointType = 1
	CheckpointType_ProductionOnly CheckpointType = 2
	CheckpointType_Standard       CheckpointType = 3
)

var CheckpointType_name = map[int32]string{
	0: "Production",
	1: "Disabled",
	2: "ProductionOnly",
	3: "Standard",
...
var CheckpointType_value = map[string]int32{
	"Production":     0,
	"Disabled":       1,
	"ProductionOnly": 2,
	"Standard":       3,
...
func (x CheckpointType) String() string {
	return proto.EnumName(CheckpointType_name, int32(x))
}
...
func init() {
	...
	proto.RegisterEnum("moc.VirtualMachineCheckpointOperation", VirtualMachineCheckpointOperation_name, VirtualMachineCheckpointOperation_value)
	...
	proto.RegisterEnum("moc.CheckpointType", CheckpointType_name, CheckpointType_value)
...
var fileDescriptor_7d1a061f6c82445b = []byte{
	...
	,
}
