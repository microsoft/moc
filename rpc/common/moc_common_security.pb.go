...
const (
	...
	Algorithm_AES_128_CBC_HMAC_SHA256 Algorithm = 5
	Algorithm_AES_128_CBC_HMAC_SHA512 Algorithm = 6
	Algorithm_AES_256_CBC_HMAC_SHA256 Algorithm = 7
	Algorithm_AES_256_CBC_HMAC_SHA512 Algorithm = 8
)
...
var Algorithm_name = map[int32]string{
	...
	3: "RSAOAEP256",
	4: "A256KW",
	5: "AES_128_CBC_HMAC_SHA256",
	6: "AES_128_CBC_HMAC_SHA512",
	7: "AES_256_CBC_HMAC_SHA256",
	8: "AES_256_CBC_HMAC_SHA512",
}
...
var Algorithm_value = map[string]int32{
	...
	"RSAOAEP256":              3,
	"A256KW":                  4,
	"AES_128_CBC_HMAC_SHA256": 5,
	"AES_128_CBC_HMAC_SHA512": 6,
	"AES_256_CBC_HMAC_SHA256": 7,
	"AES_256_CBC_HMAC_SHA512": 8,
}
...
var fileDescriptor_0d3874efde778ac1 = []byte{
	...
	,
}
